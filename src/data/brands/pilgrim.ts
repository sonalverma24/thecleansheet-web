...
const products: ProductScorecard[] = [
    ...
    pillars: [
      {
        ...
        score: 43, max: 50,
        note: "All ingredients compliant under India CDSCO, EU Regulation 1223/2009, and US FDA 21 CFR. No restricted or prohibited substances detected. Sodium Hydroxide at final INCI position is a pH adjuster only, not a bulk ingredient. Phenoxyethanol at position 14 is within EU/India 1% limit. No fragrance allergens above EU threshold. Carbomer is a synthetic polymer with low concern at cosmetic use concentrations. Minor deduction for Sodium Hydroxide requiring careful pH calibration - if formula drifts alkaline, barrier disruption risk increases.",
      },
      {
        name: "Formulation Quality",
        score: 17, max: 20,
        note: "Multi-weight HA strategy is well-evidenced: high-MW HA (Sodium Hyaluronate) forms a surface film for immediate plumping, low-MW (Hydrolyzed Hyaluronic Acid) penetrates to upper dermis. Sodium Acetylated Hyaluronate (third-generation HA) is lipophilically modified for superior skin affinity and prolonged moisture retention. Glycerin as position 4 humectant and Panthenol for barrier repair round out the formulation logic. Aloe Barbadensis Leaf Juice and Centella Asiatica Extract add soothing actives at functional positions.",
      },
      {
        name: "Claims & Transparency",
        score: 15, max: 20,
        note: "INCI disclosed on brand website. Brand states 2% Hyaluronic Acid which is well above effective hydration thresholds. Individual HA fractions and their molecular weights not disclosed separately (industry standard gap). No active concentration ranges for supporting ingredients. No clinical study PDFs published for this formula.",
      },
      {
        name: "Ethics & Sustainability",
        score: 8, max: 10,
        note: "PETA-certified cruelty-free. Not sold in China or other mandatory animal-testing markets. Indian brand. No synthetic fragrance, no azo dyes. Carbomer and Hydroxyethylcellulose are synthetic-derived polymers, mild deduction for COSMOS natural origin score. RSPO palm derivative sourcing not independently verified.",
      },
    ],
    keyActives: [
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 41, max: 50,
        note: "All ingredients compliant under India, EU, and US regulations. Kojic Acid is permitted in EU cosmetics at up to 1% in face care (SCCS opinion 2021). No sensitisation data suggests meaningful risk at cosmetic concentrations. Alpha Arbutin is the glycosylated form of hydroquinone but does not share hydroquinone's regulatory restrictions at cosmetic use levels. Sodium Ascorbyl Phosphate is a well-tolerated stable vitamin C derivative. Minor deduction: Kojic Acid can cause irritation on disrupted barrier; brand does not explicitly flag this contraindication for compromised skin.",
      },
      {
        name: "Formulation Quality",
        score: 16, max: 20,
        note: "Four-mechanism brightening formula is well-evidenced. Niacinamide at position 2 (brand-confirmed 10%) inhibits melanosome transfer. Kojic Acid inhibits tyrosinase enzyme. Alpha Arbutin provides additional tyrosinase inhibition via a different binding pathway. Sodium Ascorbyl Phosphate reduces already-formed melanin. Ferulic Acid at mid-INCI position provides antioxidant stabilisation. The multi-mechanism approach is scientifically substantiated and reduces risk of tolerance to any single brightener.",
      },
      {
        name: "Claims & Transparency",
        score: 14, max: 20,
        note: "INCI disclosed on brand website. Brand confirms Niacinamide at 10%. Kojic Acid concentration not published (industry standard gap; EU max is 1%). Alpha Arbutin and Ferulic Acid concentrations undisclosed. No third-party clinical PDFs published for this specific formula. Minor deduction for lack of Kojic Acid percentage disclosure given its regulatory sensitivity.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. No fragrance or synthetic dyes. Kojic Acid is a fermentation byproduct (Aspergillus flavus), naturally derived origin. Synthetic polymer (Carbomer) present. RSPO sourcing unverified. Minor deduction for packaging sustainability disclosure gaps.",
      },
    ],
    keyActives: [
  ...
  ------------------------------------------------- */
  {
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 37, max: 50,
        note: "Salicylic Acid at 2% is at the EU maximum for leave-on cosmetics (Annex III limit for non-rinse-off products). Compliant but at the regulatory ceiling, requiring careful pH calibration for efficacy without over-exfoliation. Tea Tree Leaf Oil (Melaleuca Alternifolia) in a leave-on format receives a sensitisation deduction: SCCS 2015 opinion flagged sensitisation potential from terpene oxidation products; EU industry guidance recommends rinse-off preference or concentration limits for leave-on use. No concentration disclosed by brand. Niacinamide at 3% is below the 5-10% range with the strongest evidence for sebum regulation, though anti-inflammatory benefit begins at lower concentrations.",
      },
      {
        name: "Formulation Quality",
        score: 15, max: 20,
        note: "Salicylic Acid at 2% is the globally validated concentration for comedolytic activity and mild acne. Niacinamide provides anti-inflammatory benefit and mild sebum regulation. Zinc PCA is an evidence-backed antimicrobial and sebum-regulating zinc complex. Tea Tree Oil adds an antimicrobial dimension but INCI position analysis cannot confirm a safe and effective concentration. Centella Asiatica Extract at a supporting position aids barrier integrity post-exfoliation. Overall formulation logic is sound but Tea Tree Oil in leave-on reduces confidence.",
      },
      {
        name: "Claims & Transparency",
        score: 11, max: 20,
        note: "Salicylic Acid confirmed at 2%, Niacinamide at 3% by brand. Tea Tree Oil concentration not disclosed - a material gap given sensitisation concerns for leave-on use. No clinical study data published. INCI structure disclosed publicly on brand website. Deduction for failing to disclose Tea Tree concentration in a leave-on product where sensitisation risk is concentration-dependent.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. No synthetic fragrance, no azo dyes. Tea Tree Oil is a natural-origin ingredient but can oxidise over time if packaging is not airtight. RSPO sourcing unverified.",
      },
    ],
    keyActives: [
    ...
    warn_badges: ["Tea Tree Oil (Leave-On)"],
  ...
  ------------------------------------------------- */
  {
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 36, max: 50,
        note: "3-O-Ethyl Ascorbic Acid is a well-characterised stable vitamin C derivative with good safety profile. Ferulic Acid and Tocopherol are safe and provide antioxidant support. Primary concern: Citrus Aurantium Bergamia Fruit Oil (Bergamot) contains bergapten, a furanocoumarin phototoxin. EU Annex III restricts bergapten to 0.0015% in leave-on sun-exposed products. Bergamot oil without bergapten removal is a sensitisation and phototoxicity risk in a leave-on brightening serum. Citrus Limon Peel Oil carries similar phototoxic furanocoumarin content. Brand does not disclose whether bergapten-free (FCF) variants are used. The absence of this disclosure warrants a significant safety deduction for a product marketed for brightening.",
      },
      {
        name: "Formulation Quality",
        score: 15, max: 20,
        note: "EAA at 15% is a well-designed stable vitamin C format. Ferulic Acid enhances antioxidant activity and helps stabilise EAA. Tocopherol (vitamin E) adds additional free-radical quenching. Sodium Hyaluronate and Panthenol provide hydration support. Formulation logic is sound. The citrus oils are inconsistent with the formulation philosophy of a brightening vitamin C serum - citrus-derived furanocoumarins can counteract brightening results by inducing pigmentation under UV exposure.",
      },
      {
        name: "Claims & Transparency",
        score: 11, max: 20,
        note: "EAA confirmed at 15% by brand. Ferulic Acid and Tocopherol concentrations not disclosed. Brand does not disclose whether Bergamot Oil is bergapten-free (FCF). This is a material transparency gap for a leave-on product containing a known photosensitiser. No clinical study data published. Deduction for failing to disclose photosensitivity risk in product marketed for daytime brightening use.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. Citrus oils are natural origin but introduce a safety concern. No synthetic fragrance beyond citrus essential oils. RSPO sourcing unverified. Minor packaging sustainability deduction.",
      },
    ],
    keyActives: [
    ...
    warn_badges: ["Phototoxic Citrus Oils"],
    info_badges: ["Stable Vitamin C (EAA)", "Always Use SPF After Application"],
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 39, max: 50,
        note: "Vitis Vinifera Seed Extract and Resveratrol are well-characterised antioxidants with strong safety profiles. Niacinamide and Retinyl Palmitate are established cosmetic actives. CI 16035 (Allura Red, azo dye) is EU-approved for cosmetic use but is a known contact allergen in sensitised individuals. In a leave-on product with no functional role for the dye, inclusion increases sensitisation risk without benefit. The SCCS position on azo dyes in leave-on products recommends caution for reactive skin. Retinyl Palmitate is a mild retinoid ester; significantly less potent than retinol or retinoic acid, with corresponding lower irritation risk but also lower efficacy. Phenoxyethanol within 1% limit.",
      },
      {
        name: "Formulation Quality",
        score: 14, max: 20,
        note: "Resveratrol is a polyphenol with in-vitro evidence for antioxidant and anti-ageing signalling (SIRT1 pathway activation). Vitis Vinifera Seed Extract provides proanthocyanidin antioxidant support. Niacinamide at a supporting position adds barrier and anti-inflammatory benefit. Retinyl Palmitate must undergo two esterase conversions (palmitate to retinol, retinol to retinoic acid) in skin before reaching active form, making it substantially less effective than retinol at equivalent position. The formulation is antioxidant-rich but the retinoid signal is weak. CI 16035 has no formulation function.",
      },
      {
        name: "Claims & Transparency",
        score: 13, max: 20,
        note: "INCI disclosed on brand website. Active concentrations for Resveratrol, Grape Seed Extract, and Retinyl Palmitate not disclosed. Brand does not call out CI 16035 as a cosmetic colourant serving no functional role. No distinction made between Retinyl Palmitate (ester) and Retinol - these are not equivalent in efficacy. No clinical study data published.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. No synthetic fragrance. CI 16035 is a synthetic azo dye, deduction for inclusion in a leave-on product. Grape-derived ingredients from Vitis Vinifera offer high natural origin index contribution. RSPO sourcing unverified.",
      },
    ],
    keyActives: [
  ...
  ------------------------------------------------- */
  {
    ...
    summary: "A retinol-positioning night cream combining Vitis Vinifera extracts with Retinol as the active retinoid. Significant concerns: Parfum (synthetic fragrance compound mixture) in a leave-on retinol product is a meaningful concern since retinol already increases skin sensitivity and inflammation risk, and fragrance allergens compound that. Additionally, two azo dyes (CI 16035 and CI 45380) are present as cosmetic colourants with no functional benefit, adding unnecessary allergen load to a leave-on night treatment. Retinol concentration is undisclosed. The combination of fragrance, dual azo dyes, and retinol in a leave-on overnight format represents a significant formulation concern.",
    score: 52,
    scoreLabel: "Concern",
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 27, max: 50,
        note: "Retinol is an effective retinoid when used at 0.1-1% in stable, appropriate vehicles. Concentration not disclosed by Pilgrim. Parfum (fragrance mixture) in a leave-on retinol product: retinol increases skin permeability and sensitisation risk; layering undisclosed fragrance allergens amplifies irritation and sensitisation exposure, particularly with 8+ hour overnight contact time. EU Annex III requires individual fragrance allergens above 0.001% to be named in leave-on products - 'Parfum' as a single entry without allergen breakdown is insufficient disclosure. CI 16035 (azo dye) and CI 45380 (fluorescein derivative) are both leave-on contact allergens with no functional benefit in a skin-treatment night product. Cumulative allergen deductions significant.",
      },
      {
        name: "Formulation Quality",
        score: 12, max: 20,
        note: "Retinol + grape polyphenols (Vitis Vinifera) as antioxidant support is a coherent anti-ageing pairing. Retinol is the most evidence-backed retinoid for collagen stimulation, wrinkle reduction, and epidermal turnover. The gel-creme vehicle with Cetearyl Alcohol and Cetearyl Glucoside provides appropriate emollient support for overnight use. Dimethicone adds occlusion for overnight efficacy. However, the undisclosed retinol concentration is a formulation quality gap - sub-functional retinol (below 0.025%) would render retinol labelling misleading. Parfum and dual dyes add unnecessary processing complexity without benefit.",
      },
      {
        name: "Claims & Transparency",
        score: 8, max: 20,
        note: "Retinol concentration not disclosed. Parfum listed without breakdown of component allergens as required by EU Regulation 1223/2009 Annex III for leave-on products. Two azo dyes present with no functional explanation. Brand does not explicitly flag pregnancy contraindication (standard international practice for any retinoid-containing product). Significant transparency deductions across all sub-categories.",
      },
      {
        name: "Ethics & Sustainability",
        score: 5, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. Parfum and two synthetic dyes reduce natural origin index and are on COSMOS prohibited list. Significant natural origin deduction. Dimethicone (silicone) is also COSMOS-prohibited for natural certifications.",
      },
    ],
    keyActives: [
    ...
    ingredients: [
      ...
      { name: "Parfum",                              note: "Fragrance mixture in a leave-on retinol night product: increases sensitisation and allergen exposure over 8+ hour contact; EU Annex III requires individual allergen disclosure above 0.001%, not met by single Parfum entry", flag: "warn" },
    ...
    warn_badges: ["Parfum in Leave-On", "Dual Azo Dyes", "Retinol % Undisclosed"],
  ...
  ------------------------------------------------- */
  {
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 37, max: 50,
        note: "Glycolic Acid (AHA) at 25% is a high cosmetic concentration. EU Annex III permits up to 10% AHA in leave-on rinse-off and up to 30% in professional-grade products with appropriate pH and contact time instructions. The classification of this product as a cosmetic vs. professional peel depends on pH and contact time. Brand does not disclose pH. Salicylic Acid at 2% is at the EU leave-on maximum but appropriate as a rinse-off treatment peel. Gluconolactone (PHA) at 5% is well-tolerated, large molecular weight reduces deeper penetration risk. Niacinamide and Panthenol at supporting positions help offset peel-related inflammation. No fragrance, no dyes - appropriate for a high-acid product.",
      },
      {
        name: "Formulation Quality",
        score: 15, max: 20,
        note: "Multi-acid strategy is well-designed: Glycolic Acid provides deep AHA exfoliation and collagen stimulation at functional concentrations; Lactic Acid adds hydrating AHA benefit with slightly larger molecular weight; Salicylic Acid penetrates sebaceous follicles for pore-level exfoliation; Gluconolactone acts at the surface with soothing properties. Niacinamide at a supporting position reduces post-peel redness. Aloe Barbadensis Leaf Juice and Panthenol support barrier recovery. Formulation logic is coherent for a treatment peel. pH undisclosed remains a quality gap.",
      },
      {
        name: "Claims & Transparency",
        score: 12, max: 20,
        note: "AHA percentage (25%), BHA percentage (2%), and PHA percentage (5%) confirmed by brand. Individual AHA components (Glycolic vs Lactic split) not specified. Formula pH not disclosed - a critical safety parameter for any product with AHA above 10%. No mention of maximum contact time on brand product page at time of analysis. No clinical study data published.",
      },
      {
        name: "Ethics & Sustainability",
        score: 6, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. No fragrance or synthetic dyes - appropriate for a high-acid treatment. Dipropylene Glycol is a synthetic solvent. RSPO sourcing unverified. Packaging sustainability not disclosed.",
      },
    ],
    keyActives: [
    ...
    warn_badges: [],
    info_badges: ["Treatment Use Only (Not Leave-On)", "pH Not Disclosed by Brand", "25% AHA - Start Weekly, Max 10-15 Minutes"],
  ...
  ------------------------------------------------- */
  {
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 39, max: 50,
        note: "Octinoxate (Ethylhexyl Methoxycinnamate) at INCI position 2 indicates it is a dominant UV filter concentration (typically 7.5%). FDA 2019 proposed rule found insufficient evidence to confirm GRASE status due to measurable systemic absorption and estrogenic activity in in-vitro and in-vivo studies. EU SCCS reviewed and re-confirmed safety at current limits, but the FDA concern represents legitimate regulatory divergence. Octocrylene is a photostabiliser for Avobenzone, well-characterised safety profile. Avobenzone provides UVA protection. Titanium Dioxide mineral component is safe. Cyclopentasiloxane (volatile silicone) is under EU environmental review. Phenoxyethanol within 1% limit.",
      },
      {
        name: "Formulation Quality",
        score: 16, max: 20,
        note: "Hybrid chemical-mineral UV filter system provides broad-spectrum coverage. Octocrylene photostabilises Avobenzone, preventing UVA filter degradation over sun exposure time - good formulation practice. Titanium Dioxide adds physical scatter component. Niacinamide at 2% provides anti-inflammatory and mild brightening support in a daily SPF. Sodium Hyaluronate and Tocopheryl Acetate provide hydration and antioxidant support. Dimethicone and Cyclopentasiloxane provide the lightweight, non-greasy texture appropriate for Indian daily SPF use. SPF 50+ PA+++ indicates adequate UVA protection testing performed.",
      },
      {
        name: "Claims & Transparency",
        score: 12, max: 20,
        note: "SPF 50+ and PA+++ claims require validated testing (ISO 24444 and ISO 24443 or JCIA methods). Brand markets SPF 50+ claim but does not publish testing methodology or data. Octinoxate concentration not disclosed. Niacinamide at 2% (below the 5-10% range with strongest brightening evidence) but consistent with its supporting role in a sunscreen formula. FDA endocrine safety concern not acknowledged in product communications.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA-certified cruelty-free. Indian brand, not sold in mandatory-testing markets. No synthetic fragrance or azo dyes. Cyclopentasiloxane is a volatile silicone under EU environmental review. Octinoxate is a documented marine ecosystem disruptor (Hawaii, Palau ban). Titanium Dioxide is the most environmentally neutral UV filter. RSPO sourcing unverified.",
      },
    ],
    keyActives: [
      ...
      { name: "Butyl Methoxydibenzoylmethane (Avobenzone)", function: "Broad-spectrum UVA chemical filter" },
    ...
    ingredients: [
      { name: "Aqua",                                note: "Solvent base",                                                                                                         flag: "ok"   },
      { name: "Ethylhexyl Methoxycinnamate",         note: "Octinoxate, UVB chemical filter; FDA 2019 proposed rule found insufficient GRASE evidence due to systemic absorption and estrogenic activity in-vitro; EU SCCS confirmed at current limits; Hawaii/Palau banned for coral reef toxicity", flag: "warn" },
      { name: "Octocrylene",                         note: "UV filter and photostabiliser for Avobenzone; well-characterised safety profile; minor concern around benzophenone degradation product under prolonged UV", flag: "info" },
    ...
    warn_badges: ["Octinoxate (FDA Review)"],
