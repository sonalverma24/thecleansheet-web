...
export const metadata = {
  title: "Our Services | Beauty Product Certification & Claims Verification",
  description:
    "India's first science-backed beauty product certification and claims verification service. The Clean Sheet evaluates products across 5 pillars: ingredients, compliance, manufacturing, claims, and ethics.",
  keywords: [
    "beauty product certification India", "claims verification beauty", "clean beauty certification",
    "cosmetic safety certification India", "ingredient compliance India", "beauty brand certification", "certified skincare India",
  ],
  alternates: { canonical: "https://thecleansheet.in/services" },
  openGraph: {
    title: "Our Services | The Clean Sheet™",
    description:
      "India's science-backed cosmetic certification and claims verification. A rigorous five-pillar evaluation covering ingredients, claims, manufacturing, compliance, and ethics.",
    url: "https://thecleansheet.in/services",
    type: "website",
  },
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="cert-reveal" style={{ animationDelay:"0.1s" }}>
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-medium tracking-tight leading-[1.04] text-white mb-6">
                Our
                <br />
                <span style={{ background:"linear-gradient(90deg,#5eead4,#99f6e4)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>Services.</span>
              </h1>
              <p className="text-teal-200/70 text-lg sm:text-xl leading-relaxed max-w-xl mb-10">
                From claims verification to full product certification, The Clean Sheet gives brands a credible, independent path to proving what they say is true.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#apply"
                  className="inline-flex items-center gap-2 bg-coral-500 hover:bg-coral-600 text-white font-normal px-7 py-3.5 rounded-2xl transition-all text-sm hover:shadow-lg hover:shadow-coral-500/25">
                  Get your claims verified today <ArrowRight size={15} />
                </a>
                <a href="#methodology"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <a href="mailto:hello@thecleansheet.in?subject=Services%20Enquiry"
