module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},13452,e=>{"use strict";var t=e.i(24389);e.s(["createAdminClient",0,function(){return(0,t.createClient)("https://xivtoayjkpnfkafrxghq.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY,{auth:{autoRefreshToken:!1,persistSession:!1}})}])},77465,e=>{"use strict";var t=e.i(13452);function r(e){return{slug:String(e.slug),productName:String(e.product_name??""),brand:String(e.brand??""),score:Number(e.score??0),scoreLabel:String(e.score_label??""),integrityScore:null==e.integrity_score?null:Number(e.integrity_score),imageUrl:e.image_url??null,summary:String(e.summary??""),usageGuidance:e.usage_guidance??null,verifiedAt:String(e.verified_at??new Date().toISOString()),methodologyVersion:String(e.methodology_version??"")}}async function n(e){try{let r=(0,t.createAdminClient)(),{data:n}=await r.from("verified_products").select("image_url,usage_guidance,integrity_score").eq("slug",e.slug).maybeSingle();await r.from("verified_products").upsert({slug:e.slug,product_name:e.productName,brand:e.brand,score:e.score,score_label:e.scoreLabel,integrity_score:e.integrityScore??n?.integrity_score??null,image_url:e.imageUrl??n?.image_url??null,summary:e.summary,usage_guidance:e.usageGuidance??n?.usage_guidance??null,verified_at:e.verifiedAt,methodology_version:e.methodologyVersion,updated_at:new Date().toISOString()},{onConflict:"slug"})}catch{}}async function a(){try{let e=(0,t.createAdminClient)(),{data:n}=await e.from("verified_products").select("*").order("verified_at",{ascending:!1}).limit(200);return Array.isArray(n)?n.map(r):[]}catch{return[]}}e.s(["listVerifiedProducts",0,a,"slugify",0,function(e,t){return`${t} ${e}`.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,80)},"upsertVerifiedProduct",0,n])},89104,e=>{"use strict";let t=new Map,r=Date.now();e.s(["rateLimit",0,function(e,n,a){let i,o=Date.now();if(!(o-r<3e5))for(let[e,n]of(r=o,t)){let r=n.filter(e=>o-e<6e4);0===r.length?t.delete(e):t.set(e,r)}let s=`${n}:${(i=e.headers.get("x-forwarded-for"))?i.split(",")[0].trim():e.headers.get("x-real-ip")??"unknown"}`,c=(t.get(s)??[]).filter(e=>o-e<6e4);return c.length>=a?(t.set(s,c),!1):(c.push(o),t.set(s,c),!0)},"rateLimited",0,()=>Response.json({error:"Too many requests. Please wait a minute and try again."},{status:429})])},2221,e=>{"use strict";let t=`
...
If tests are found publicly (an actual study, certificate, registry entry, or published data — not just a marketing mention of "tested"): award transparency marks for that criterion
If tests are not found by search: note "lab tests not confirmed via public search" and deduct for that sub-criterion. A claim without locatable evidence earns no transparency credit. If CLAIM CHECK FINDINGS are provided in the prompt, use those verdicts directly instead of re-searching.
...
6. Transparency Practices, 10 pts
   - Lab tests, stability results, or patch test evidence confirmed publicly available (an actual document or registry entry, found on the brand site or via search) = full marks for that criterion
   - "Dermatologist-tested" or "clinically tested" claim WITH a locatable citation or linked study = positive signal
   - "Dermatologist-tested" or "clinically tested" WITHOUT any locatable citation or study = -2 pts (a claim is not evidence)
   - Sustainability and supply chain disclosure = positive signal
   - If CLAIM CHECK FINDINGS are provided in the prompt, score this pillar from those verdicts: verified claims = credit, unverified/not_permitted claims = deductions
...
- "Unsubstantiated Claims": for "chemical-free"/"toxin-free" language, or for "clinically tested"/"dermatologist tested"/"lab tested" claims where no supporting evidence (study, certificate, registry entry) could be located after searching. If CLAIM CHECK FINDINGS are provided, assign this badge when any claim has verdict "unverified" or "not_permitted"
...

{
  ...
  "usageGuidance": {
    "howToUse": ["2-4 concrete steps with specific timings and quantities, e.g. 'Massage onto damp skin and leave for 5-6 minutes before rinsing' — derived from the product type, actives, and their concentrations. Never generic filler."],
    "frequency": "how often to use, e.g. '2-3 times a week, evenings' — based on active strength and irritation profile",
    "pairWith": ["ingredient or product type that improves results, with the reason, e.g. 'Follow with a lactic acid + urea body lotion to boost exfoliation and hydration'"],
    "avoidWith": ["ingredient combinations to avoid with this product, with the reason, e.g. 'Do not layer with retinoids on the same night — compounded irritation'"],
    "proTip": "one India-specific usage tip (climate, hard water, sun exposure), 1 sentence"
  },
  "dataSource": {
...
SCORING BANDS: 90-100 Excellent \xb7 70-89 Good \xb7 50-69 Fair \xb7 Below 50 Concern
...
OUTPUT FORMAT:
{
  ...
  "verdictLabel": "one short phrase e.g. Generally Safe \xb7 EU Approved or Use With Caution or Avoid If Sensitive",
...
`;e.s(["CHAT_SYSTEM_PROMPT",0,a,"CLEAN_SHEET_SYSTEM_PROMPT",0,t,"COMPARISON_SYSTEM_PROMPT",0,r,"EXPERT_ANSWER_SYSTEM_PROMPT",0,n])},50786,e=>{"use strict";var t=e.i(47909),r=e.i(74017),n=e.i(96250),a=e.i(59756),i=e.i(61916),o=e.i(74677),s=e.i(69741),c=e.i(16795),l=e.i(87718),d=e.i(95169),u=e.i(47587),p=e.i(66012),m=e.i(70101),f=e.i(26937),g=e.i(10372),h=e.i(93695);e.i(20232);var y=e.i(5232),b=e.i(9359),I=e.i(71994),v=e.i(89104);async function C(e){try{if(!(0,v.rateLimit)(e,"claim-check",8))return(0,v.rateLimited)();let{query:t}=await e.json();if(!t?.trim())return Response.json({error:"No query provided"},{status:400});let r=await (0,b.runClaimCheck)(String(t));if(!r)return Response.json({type:"out_of_scope"});return Response.json(r)}catch(e){if(console.error("[claim-check]",e instanceof Error?e.message:e),e instanceof I.TransientModelError)return(0,I.busyResponse)();return Response.json({error:"Claim check failed. Please try again."},{status:500})}}e.s(["POST",0,C,"dynamic",0,"force-dynamic","maxDuration",0,120],47019);var w=e.i(47019);let R=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/claim-check/route",pathname:"/api/claim-check",filename:"route",bundlePath:""},distDir:"/tmp/tcs-next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/claim-check/route.ts",nextConfigOutput:"",userland:w,...{}}),{workAsyncStorage:S,workUnitAsyncStorage:E,serverHooks:k}=R;async function x(e,t,n){n.requestMeta&&(0,a.setRequestMeta)(e,n.requestMeta),R.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let b="/api/claim-check/route";b=b.replace(/\/index$/,"")||"/";let I=await R.prepare(e,t,{srcPage:b,multiZoneDraftMode:!1});if(!I)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:v,deploymentId:C,params:w,nextConfig:S,parsedUrl:E,isDraftMode:k,prerenderManifest:x,routerServerContext:N,isOnDemandRevalidate:A,revalidateOnlyGenerated:O,resolvedPathname:T,clientReferenceManifest:P,serverActionsManifest:_}=I,F=(0,s.normalizeAppPath)(b),U=!!(x.dynamicRoutes[F]||x.routes[T]),D=async()=>((null==N?void 0:N.render404)?await N.render404(e,t,E,!1):t.end("This page could not be found"),null);if(U&&!k){let e=!!x.routes[T],t=x.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(S.adapterPath)return await D();throw new h.NoFallbackError}}let L=null;!U||R.isDev||k||(L="/index"===(L=T)?"/":L);let M=!0===R.isDev||!U,q=U&&!M;_&&P&&(0,o.setManifestsSingleton)({page:b,clientReferenceManifest:P,serverActionsManifest:_});let H=e.method||"GET",B=(0,i.getTracer)(),j=B.getActiveScopeSpan(),G=!!(null==N?void 0:N.isWrappedByNextServer),z=!!(0,a.getRequestMeta)(e,"minimalMode"),W=(0,a.getRequestMeta)(e,"incrementalCache")||await R.getIncrementalCache(e,S,x,z);null==W||W.resetRequestCache(),globalThis.__incrementalCache=W;let V={params:w,previewProps:x.preview,renderOpts:{experimental:{authInterrupts:!!S.experimental.authInterrupts},cacheComponents:!!S.cacheComponents,supportsDynamicResponse:M,incrementalCache:W,cacheLifeProfiles:S.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,a)=>R.onRequestError(e,t,n,a,N)},sharedContext:{buildId:v,deploymentId:C}},Y=new c.NodeNextRequest(e),K=new c.NodeNextResponse(t),$=l.NextRequestAdapter.fromNodeNextRequest(Y,(0,l.signalFromNodeResponse)(t));try{let a,o=async e=>R.handle($,V).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=B.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==d.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${H} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t),a&&a!==e&&(a.setAttribute("http.route",n),a.updateName(t))}else e.updateName(`${H} ${b}`)}),s=async a=>{var i,s;let c=async({previousCacheEntry:r})=>{try{if(!z&&A&&O&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await o(a);e.fetchMetrics=V.renderOpts.fetchMetrics;let s=V.renderOpts.pendingWaitUntil;s&&n.waitUntil&&(n.waitUntil(s),s=void 0);let c=V.renderOpts.collectedTags;if(!U)return await (0,p.sendResponse)(Y,K,i,V.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(i.headers);c&&(t[g.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==V.renderOpts.collectedRevalidate&&!(V.renderOpts.collectedRevalidate>=g.INFINITE_CACHE)&&V.renderOpts.collectedRevalidate,n=void 0===V.renderOpts.collectedExpire||V.renderOpts.collectedExpire>=g.INFINITE_CACHE?void 0:V.renderOpts.collectedExpire;return{value:{kind:y.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await R.onRequestError(e,t,{routerKind:"App Router",routePath:b,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,N),t}},l=await R.handleResponse({req:e,nextConfig:S,cacheKey:L,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:x,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:O,responseGenerator:c,waitUntil:n.waitUntil,isMinimalMode:z});if(!U)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==y.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(s=l.value)?void 0:s.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});z||t.setHeader("x-nextjs-cache",A?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),k&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let d=(0,m.fromNodeOutgoingHttpHeaders)(l.value.headers);return z&&U||d.delete(g.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||d.get("Cache-Control")||d.set("Cache-Control",(0,f.getCacheControlHeader)(l.cacheControl)),await (0,p.sendResponse)(Y,K,new Response(l.value.body,{headers:d,status:l.value.status||200})),null};G&&j?await s(j):(a=B.getActiveScopeSpan(),await B.withPropagatedContext(e.headers,()=>B.trace(d.BaseServerSpan.handleRequest,{spanName:`${H} ${b}`,kind:i.SpanKind.SERVER,attributes:{"http.method":H,"http.target":e.url}},s),void 0,!G))}catch(t){if(t instanceof h.NoFallbackError||await R.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:A})},!1,N),U)throw t;return await (0,p.sendResponse)(Y,K,new Response(null,{status:500})),null}}e.s(["handler",0,x,"patchFetch",0,function(){return(0,n.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:E})},"routeModule",0,R,"serverHooks",0,k,"workAsyncStorage",0,S,"workUnitAsyncStorage",0,E],50786)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__15z6run._.js.map