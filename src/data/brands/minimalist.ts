...
const products: ProductScorecard[] = [
  ...
  ------------------------------------------------- */
  {
    ...
    ingredients: [
      ...
      { name: "Glycerin",                           note: "Humectant, position 3 indicates moderate hydration role",                                                            flag: "ok"   },
      { name: "Butylene Glycol",                    note: "Humectant and solvent, low sensitisation risk",                                                                       flag: "ok"   },
      { name: "Dimethyl Isosorbide",                note: "Penetration enhancer, position 5; increases delivery of all co-formulated actives, including systemic absorption potential", flag: "info" },
      ...
      { name: "Acetyl Glucosamine",                 note: "Brightening and mild exfoliation, inhibits melanin synthesis",                                                       flag: "ok"   },
      { name: "Pseudoalteromonas Ferment Extract",  note: "Marine bioferment, barrier conditioning and antioxidant",                                                           flag: "ok"   },
      { name: "Zinc PCA",                           note: "Antimicrobial zinc salt, functionally relevant concentration for sebum regulation",                                 flag: "ok"   },
      { name: "Zinc Glycinate",                     note: "Chelated zinc, anti-inflammatory, acne-resolution support; secondary to Zinc PCA",                                 flag: "ok"   },
      { name: "Allantoin",                          note: "Soothing and skin-repairing, buffers irritation from active ingredients",                                           flag: "ok"   },
      { name: "Sodium Hyaluronate",                 note: "HA salt for hydration, functional but not hero concentration",                                                       flag: "ok"   },
