...
export const kiehlsBrand: Brand = {
  ...
  products: [
      ...
      pillars: [
        {
          ...
          score: 39,
          max: 50,
          note: "The formula doesn't list 'Parfum' or 'Fragrance' as a single ingredient - the essential oils are declared individually by botanical name, which is the more transparent approach. The key concern here is Alcohol Denat at position 4, indicating a meaningful concentration. Denatured alcohol in daily leave-on use is a documented barrier disruptor, and long-term use on compromised or sensitive skin can gradually weaken the outermost skin layer. Lavandula Angustifolia Oil (Lavender essential oil) is present and contains Linalool, which EU regulation requires to be declared separately as a fragrance allergen. In a leave-on brightening serum typically used to treat post-inflammatory hyperpigmentation - where skin is already reactive - both the alcohol and the fragrance allergen deserve attention.",
        },
        {
          name: "Formulation Quality",
          score: 14,
        ...
        },
        {
          ...
          score: 15,
          max: 20,
          note: "Full ingredient list is published and Linalool is declared as required under EU regulation. Active concentrations are not disclosed. Where this falls short is in the gap between the 'Clearly Corrective' branding - which implies a clean, corrective formula - and the actual presence of Alcohol Denat at a meaningful level and Lavender Oil. Neither of these is addressed or flagged in any of the product's marketing communication.",
        },
        {
          name: "Ethics & Sustainability",
          score: 5,
      ...
      pillars: [
        {
          ...
          score: 35,
          max: 50,
          note: "Each essential oil is declared by its botanical name rather than grouped under 'Fragrance' - the more transparent labelling approach. However, the cumulative fragrance allergen load in this product is significant. Five declared allergens (Linalool, Limonene, Citral, Citronellol, Geraniol) come from four essential oils: Lavender, Geranium, Rosemary, and Coriander. This is an overnight leave-on product, meaning the skin is in contact with these allergens for 8 or more hours during its nightly repair cycle. Fragrance sensitisation is cumulative - repeated exposure over time increases the chance of developing a reaction, even without any immediate irritation at first use.",
        },
        {
          name: "Formulation Quality",
          score: 13,
        ...
        },
        {
          ...
          score: 15,
          max: 20,
          note: "All allergens are declared as required under EU regulation, and the full ingredient list is published on the Kiehl's product page. What isn't communicated is the distinction between what actually produces the recovery effect (the plant oil base) and what the essential oil blend contributes (fragrance only). At a price point around Rs. 6,000, a consumer reading the marketing would reasonably assume the essential oils are doing therapeutic work - they are not.",
        },
        {
          name: "Ethics & Sustainability",
          score: 5,
    ...
    // 7. Creamy Eye Treatment with Avocado
    {
      ...
      summary:
        "One of Kiehl's most iconic and long-standing products, and the one most in need of a formula update. The Creamy Eye Treatment contains four parabens: Methylparaben, Ethylparaben, Propylparaben, and Butylparaben. Butylparaben is the most scrutinised of the paraben family: it has the highest fat-solubility, longest half-life, and the greatest potential for hormone disruption in laboratory studies. While regulators concluded Butylparaben is safe at current cosmetic use levels (re-evaluated 2023), it has been removed from most modern eye cream formulations, and its presence in a product applied daily to the delicate skin around the eye is worth flagging. The avocado oil and shea butter base is genuinely emollient for the eye area, but this is a heritage formula that hasn't been modernised.",
      score: 66,
      scoreLabel: "Fair",
      ...
      pillars: [
        {
          ...
          score: 34,
          max: 50,
          note: "This product contains four parabens: Methylparaben, Ethylparaben, Propylparaben, and Butylparaben. Methylparaben and Ethylparaben have the lowest concern profile in the paraben family. Propylparaben and Butylparaben have attracted greater scrutiny - they have higher fat-solubility, meaning they accumulate more readily in tissue, and carry a greater potential for hormone disruption in laboratory studies. Butylparaben in particular has the longest tissue half-life of any paraben. The EU SCCS conducted a safety re-evaluation in 2023 and concluded that Butylparaben is safe at current cosmetic use levels - but the ingredient has been voluntarily removed from the vast majority of modern leave-on eye products. The skin around the eye is thinner and more vascular than most of the face, which means ingredients absorb more readily here. Isopropyl Palmitate, present as an emollient, has some reported comedogenicity that is relevant to milia formation under the eye.",
        },
        {
          name: "Formulation Quality",
          score: 12,
          max: 20,
          note: "Shea Butter (Butyrospermum Parkii) and Avocado Oil (Persea Gratissima) are effective emollients that perform well in the dry area around the eye. Sodium PCA is a natural humectant. The formula moisturises well - but it has no peptides, no retinoids, and no contemporary anti-ageing actives. The preservation system uses four parabens where modern formulations would typically use a single, more targeted option. This is essentially a well-executing but dated formula.",
        },
        {
          name: "Claims & Transparency",
          score: 16,
          max: 20,
          note: "All four parabens are clearly named in the ingredient list, which is published on the Kiehl's product page. There is no obscuring of the ingredient list - the disclosure is honest. What is absent is any acknowledgment that this is a heritage formula that hasn't been updated, or that the preservation approach differs from modern industry standards for leave-on eye products.",
        },
        {
          name: "Ethics & Sustainability",
          score: 4,
          max: 10,
          note: "Kiehl's is owned by L'Oreal, which sells in mainland China where animal testing can be required by regulation. This formula appears to have gone unchanged for many years, despite widely available modern preservation alternatives with better consumer acceptance. No PETA certification.",
        },
      ],
      keyActives: [
        ...
        { name: "Sodium PCA", function: "Natural humectant supporting moisture retention" },
      ...
      ingredients: [
        ...
        { name: "Butylparaben", note: "Paraben preservative in leave-on product. Highest hormone disruption concern in the paraben family; most fat-soluble with the longest half-life. Daily periocular use warrants attention. Regulators approved at current cosmetic use levels (2023), but industry trend is strongly away from this ingredient in leave-on formulations.", flag: "warn" },
      ...
      indiaContext:
        "Eye creams are a high-purchase category in India. The skin around the eye is thinner than the rest of the face, so ingredient choices matter more here. Consumers who prefer to avoid parabens, particularly Butylparaben, should check this formula before purchasing.",
