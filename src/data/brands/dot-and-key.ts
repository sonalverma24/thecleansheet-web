      ...
      pillars: [
        {
          ...
          score: 46,
          max: 50,
          note: "All UV filters are modern and photostable: Uvinul A Plus (UVA), Ethylhexyl Triazone (UVB), Tinosorb S (broad-spectrum), Tinosorb M (broad-spectrum organic-mineral hybrid), and Titanium Dioxide (physical). No Benzophenone-3, no Octinoxate, no fragrance, no azo dyes. This is one of the cleanest UV filter profiles in the Dot & Key range. Isododecane is a volatile silicone that evaporates on application. Sodium Gluconate is a biodegradable chelating agent - a better choice than EDTA.",
        },
        {
        ...
        },
        {
          ...
          score: 7,
          max: 10,
          note: "No Octinoxate, no Benzophenone-3 - both documented reef pollutants are absent, which is a positive environmental profile for a sunscreen. No synthetic fragrance. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing. Packaging is plastic.",
        },
      ],
      keyActives: [
      ...
      pillars: [
        {
          ...
          score: 45,
          max: 50,
          note: "The reformulated UV filter system is a major improvement over the previous Benzophenone-3 formula. Uvinul A Plus, Ethylhexyl Triazone, Tinosorb S, Tinosorb M, and Mexoryl SX are all modern, photostable filters with strong safety records and no endocrine disruption concerns. Titanium Dioxide provides physical broad-spectrum coverage. Synthetic fragrance has been removed. Menthyl Lactate delivers the cooling effect and is well-tolerated. Butyloctyl Salicylate is a non-sunscreen emollient ester - the 'salicylate' name sometimes causes confusion but it is inert at cosmetic concentrations and is not a UV filter.",
        },
        {
          name: "Formulation Quality",
          score: 18,
        ...
        },
        {
          ...
          score: 15,
          max: 20,
          note: "SPF 50+ PA++++ is claimed and the multi-filter system is comprehensive enough to support it. The brand does not publish an SPF test report on the product page. The full ingredient list is published on dotandkey.com. The 'Cooling' claim is substantiated by Menthyl Lactate. Worth noting: the reformulation from the Benzophenone-3 formula is not flagged by the brand, so existing consumers may not be aware the formula has changed.",
        },
        {
          name: "Ethics & Sustainability",
          score: 8,
          max: 10,
          note: "The removal of Benzophenone-3 and Octinoxate - both documented reef pollutants - is a significant environmental improvement. No synthetic fragrance. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing. Tinosorb M has a lower reef-toxicity profile than Oxybenzone or Octinoxate. Packaging is plastic.",
        },
      ],
      keyActives: [
        { name: "Uvinul A Plus (Diethylamino Hydroxybenzoyl Hexyl Benzoate)", function: "Photostable UVA filter, excellent safety record" },
    ...
    // 5. Strawberry Bright 10% Niacinamide Serum
    {
      ...
      pillars: [
        ...
        },
        {
          ...
          score: 7,
          max: 10,
          note: "No synthetic fragrance. One azo dye (CI 42090) is present; azo dyes have minor documented effects on aquatic organisms. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing. Packaging is plastic.",
        },
      ],
      keyActives: [
    ...
    // 10. Strawberry Dew Tinted Sunscreen SPF 50+
    {
      ...
      pillars: [
        ...
        },
        {
          ...
          score: 7,
          max: 10,
          note: "No synthetic fragrance. No Octinoxate, no Benzophenone-3 - both documented reef pollutants are absent. Iron oxide mineral pigments replace azo dyes as colourants - a cleaner environmental and safety profile. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing. Packaging is plastic.",
        },
      ],
      keyActives: [
        { name: "Uvinul A Plus (Diethylamino Hydroxybenzoyl Hexyl Benzoate)", function: "Photostable UVA filter, excellent safety record" },
