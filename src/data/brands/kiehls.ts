...
export const kiehlsBrand: Brand = {
  ...
  products: [
    ...
    // ─── 1. Ultra Facial Cream ────────────────────────────────────────────────
    {
      ...
      pillars: [
        { name: "Ingredient Safety",    score: 22, max: 25, note: "No fragrance, no parabens. Myristyl Myristate at position 10 has reported comedogenicity in occlusion studies, warranting a minor deduction. Chlorphenesin not present. All ingredients within global regulatory limits." },
        { name: "Irritation Potential", score: 15, max: 20, note: "Fragrance-free and essential oil-free. Dimethicone forms an occlusive film that is generally non-sensitising. Salicylic Acid at tail position is pH-adjuster/preservative level, not an irritation concern at this concentration." },
        { name: "Disclosure Quality",   score: 15, max: 20, note: "Full INCI published. No percentage disclosures for actives (Squalane, ceramide precursor concentrations not stated). Formula is positioned as a 'moisturiser' without specific active claims, which is appropriately modest." },
        ...
        { name: "Efficacy",             score: 11, max: 15, note: "Multi-oil emollient base is well-suited for dry skin types. Squalane is skin-identical and non-comedogenic. Ceramide precursor (Hydroxypalmitoyl Sphinganine) paired with Ferment Extract provides barrier support. No high-potency actives: this is a maintenance moisturiser, not a treatment." },
        { name: "Transparency",         score:  7, max: 10, note: "Marketed as the 'original' formula with heritage positioning. No ingredient concentrations disclosed. Myristyl Myristate comedogenicity risk is not communicated. Otherwise honest positioning." },
      ],
      keyActives: [
    ...
    // ─── 2. Calendula Herbal Extract Alcohol-Free Toner ───────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 21, max: 25, note: "No fragrance, no alcohol. Chlorphenesin at position 6 is a higher position than usual for a preservative; within global limits but slightly elevated versus industry norm. No parabens." },
        ...
        { name: "Disclosure Quality",   score: 15, max: 20, note: "INCI published. Calendula extract concentration not disclosed. Chlorphenesin's high position relative to botanical actives could suggest more preservative than calendula, representing a transparency gap." },
        { name: "Regulatory",           score:  9, max: 10, note: "Fully compliant. All ingredients within Indian and EU regulations." },
        { name: "Efficacy",             score: 10, max: 15, note: "Calendula and Burdock Root are documented for anti-inflammatory and antioxidant activity. Allantoin is soothing. However, this is primarily a prep/conditioning toner that does not deliver high-potency actives. Hydrolyzed Corn Starch adds skin feel." },
    ...
    // ─── 3. Clearly Corrective Dark Spot Solution ─────────────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 17, max: 25, note: "Alcohol Denat at position 4 is a significant concern for a leave-on daily serum. Lavender oil (fragrance) with declared Linalool allergen. Salicylic Acid may enhance alcohol penetration of other actives, compounding the concern. No parabens." },
        { name: "Irritation Potential", score: 12, max: 20, note: "Alcohol Denat combined with Lavender oil and Linalool in a leave-on brightening serum creates an elevated irritation and sensitisation stack. Salicylic Acid adds mild exfoliation. Combined with daily use on dark-spot-prone skin (often post-inflammatory and sensitive), this is a meaningful concern." },
        { name: "Disclosure Quality",   score: 15, max: 20, note: "INCI published. Linalool disclosed as required by EU regulation. The 3-O-Ethyl Ascorbic Acid percentage is not disclosed. Alcohol Denat presence is transparent but not called out in marketing." },
        ...
        { name: "Efficacy",             score:  9, max: 15, note: "3-O-Ethyl Ascorbic Acid is a well-regarded stable Vitamin C derivative with brightening evidence. The HA analogue adds hydration. Salicylic Acid provides mild exfoliation to accelerate cell turnover. Efficacy is real, but the delivery vehicle (alcohol) may compromise skin integrity over time." },
        { name: "Transparency",         score:  4, max: 10, note: "The 'clearly corrective' positioning implies a clean and corrective formula, but Alcohol Denat at position 4 and Lavender Oil are not consistent with this framing. No disclosure of alcohol as a sensitisation risk." },
      ],
      keyActives: [
    ...
    // ─── 4. Midnight Recovery Concentrate ────────────────────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 13, max: 25, note: "5 declared IFRA allergens (Linalool, Limonene, Citral, Citronellol, Geraniol) in a leave-on overnight concentrate. Lavender, Geranium, Rosemary, and Coriander essential oils are all present. Sclareolide (synthetic ambergris) is a fragrance ingredient with mild concern. No parabens." },
        { name: "Irritation Potential", score:  9, max: 20, note: "Five EU-declared fragrance allergens in a leave-on overnight product applied to skin undergoing its barrier repair cycle. Sensitisation risk is meaningful and cumulative with daily use." },
        { name: "Disclosure Quality",   score: 14, max: 20, note: "All allergens declared as required by EU regulation. INCI is transparent. However, the product is marketed as a 'recovery concentrate' without communicating that the recovery mechanism is the oil base, not the fragrance." },
        ...
        { name: "Transparency",         score:  4, max: 10, note: "'Recovery Concentrate' positioning implies active skin repair. The meaningful recovery work is done by the plant oils; the essential oil fragrance blend is not a recovery active, and this distinction is not made. The price (~₹6,000) is high for a fragrant plant oil blend." },
      ],
      keyActives: [
    ...
    // ─── 5. Powerful-Strength Line-Reducing Concentrate ───────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 15, max: 25, note: "Cyclohexasiloxane (D6) is EU-restricted for rinse-off products since 2020; present in this leave-on at restricted levels. Acrylonitrile copolymer raises microplastic concerns per EU Microplastics Restriction 2023. Citrus oils with Limonene and Citral in a daytime serum carry phototoxic potential." },
        { name: "Irritation Potential", score: 12, max: 20, note: "Citrus peel oils (Orange and Lemon) combined with Limonene and Citral in a daytime product. L-Ascorbic Acid at 10.5% requires low pH (3–3.5) with potential for transient stinging. Combined with citrus oils, the irritation and sensitisation risk is elevated." },
        { name: "Disclosure Quality",   score: 15, max: 20, note: "The brand discloses 10.5% L-Ascorbic Acid and 2% Ascorbyl Glucoside, which is good active transparency. Cyclohexasiloxane and Acrylonitrile copolymer are present without comment. Citrus oils are disclosed." },
        { name: "Regulatory",           score:  7, max: 10, note: "D6 silicone is technically permitted in leave-on at restricted concentration but is under increasing EU restrictions. Acrylonitrile copolymer is flagged under EU Microplastics Restriction. Otherwise compliant." },
        { name: "Efficacy",             score: 11, max: 15, note: "10.5% L-Ascorbic Acid is clinically potent, well above the threshold for collagen stimulation and antioxidant activity. At 2%, Ascorbyl Glucoside adds a stability buffer. Hydrolyzed Hyaluronic Acid provides hydration. Adenosine adds anti-ageing benefit." },
        { name: "Transparency",         score:  4, max: 10, note: "Marketed as a premium anti-ageing serum without disclosure of the D6 silicone regulatory trajectory, the microplastic concern in the copolymer, or the phototoxicity risk from citrus oils in a daytime product." },
      ],
      keyActives: [
    ...
    // ─── 6. Rare Earth Deep Pore Cleansing Masque ─────────────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 22, max: 25, note: "No fragrance, no parabens, no dyes, no essential oils. Ceteareth-20 is a PEG-derived emulsifier with mild concern regarding ethylene oxide potential, an industry-standard issue. Titanium Dioxide (CI 77891) is a mineral pigment that is safe and inert." },
        { name: "Irritation Potential", score: 18, max: 20, note: "Fragrance-free. No alcohol. Aloe, Oat, and Allantoin actively buffer the clay's drying effect. Rinse-off format reduces contact time. Very low irritation risk for a clay mask." },
        { name: "Disclosure Quality",   score: 16, max: 20, note: "INCI published. Clay types (Kaolin and Bentonite, which have different mineral structures) are both listed. No concentration disclosure." },
        ...
        { name: "Transparency",         score:  6, max: 10, note: "'Rare Earth' branding refers to Amazonian White Clay, which is essentially Kaolin. This is not a misleading claim but is a marketing embellishment of a common ingredient." },
      ],
      keyActives: [
    ...
    // ─── 7. Creamy Eye Treatment with Avocado ─────────────────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 14, max: 25, note: "Four parabens: Methylparaben, Ethylparaben, Propylparaben, and Butylparaben. Butylparaben has the highest endocrine disruption concern in the paraben family. Daily periocular application to thin, vascular skin warrants attention. EU SCCS approved at current levels (2023 re-evaluation), but the industry trend is strongly away from Butylparaben." },
        { name: "Irritation Potential", score: 10, max: 20, note: "No fragrance, no essential oils, which are positives. Four parabens including Butylparaben are sensitisers in paraben-allergic individuals. Isopropyl Palmitate (position 20) has reported comedogenicity relevant to milia under the eyes. Ozokerite (petroleum-derived wax) is occlusive." },
        { name: "Disclosure Quality",   score: 15, max: 20, note: "INCI fully published. All four parabens clearly listed. No attempt to obscure. The product is honest in disclosure even if the formula is dated." },
        { name: "Regulatory",           score:  8, max: 10, note: "All four parabens are currently permitted. Butylparaben is restricted in Europe for products on children under 3 and in the nappy area, which is not applicable here. EU SCCS 2023 re-evaluation deemed safe at current cosmetic use levels." },
        { name: "Efficacy",             score:  9, max: 15, note: "Butyrospermum Parkii (Shea Butter) and Persea Gratissima Oil (Avocado) provide genuine emolliency for the dry periocular area. Sodium PCA is a natural humectant. Copper PCA may contribute mild antioxidant activity. No peptides, retinoids, or other contemporary anti-ageing actives are present: this is primarily a moisturising eye cream." },
    ...
    // ─── 8. Ultra Facial Cleanser ─────────────────────────────────────────────
    {
      ...
      analyzedAt: "2026-05-18",
      pillars: [
        { name: "Ingredient Safety",    score: 14, max: 25, note: "Polyaminopropyl Biguanide (PHMB) is EU-restricted in rinse-off cosmetics at >0.1% since 2019. Three parabens including Propylparaben. SLES at position 2. Triethanolamine carries potential nitrosamine formation risk at high concentration, though low risk at neutral pH. Multiple concerning ingredients in a single daily-use cleanser." },
        { name: "Irritation Potential", score: 10, max: 20, note: "SLES is significantly more irritating than amino acid surfactants or glucosides, with daily barrier disruption risk. PHMB has reported contact sensitisation data. The paraben combination adds allergen risk for sensitive individuals." },
        { name: "Disclosure Quality",   score: 14, max: 20, note: "INCI fully published with all ingredients visible. PHMB is disclosed, but its EU restriction is not communicated. Parabens are named clearly." },
        { name: "Regulatory",           score:  6, max: 10, note: "PHMB in rinse-off products has been restricted by EU since 2019; this product may not be compliant for EU sale at current concentration. Indian regulations may not have this specific restriction. Needs verification on current market status." },
        ...
        { name: "Transparency",         score:  4, max: 10, note: "PHMB's EU restriction status and paraben presence are not disclosed in product communications. SLES as the primary surfactant is not called out for consumers who may be monitoring their surfactant intake." },
      ],
      keyActives: [
