    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 pt-10 pb-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 mb-6 border-b border-teal-800 animate-fade-in">
            ...
            <p className="text-teal-500 text-xs leading-relaxed max-w-xs">
              No commercial relationship with CodeSkin. We reviewed their formula,
              lab reports, and label. This page shows only what the evidence supports.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-end gap-8 lg:gap-12">
            <div className="flex-1">
              ...
              <p className="text-teal-300 text-base font-semibold tracking-tight mb-0.5 animate-fade-up delay-100">SPF 50+ PA++++</p>
              <p className="text-teal-500 text-xs font-medium tracking-wide mb-4 animate-fade-up delay-100">CodeSkin India</p>
              ...
              <div className="flex flex-wrap gap-2 animate-fade-up delay-200">
                ...
                <span className="flex items-center gap-1.5 text-[10px] font-semibold bg-coral-500 text-white px-2.5 py-1 rounded-full">
                  <Sun size={8} /> PRISM Sun Verified
                </span>
              </div>

              <p className="text-teal-500 text-xs leading-relaxed max-w-sm mt-5 animate-fade-up delay-300">
                Every claim reviewed by an independent panel of cosmetic scientists, toxicologists,
            ...
            <div className="flex-shrink-0 animate-fade-up delay-200">
              <div className="animate-float relative">
                ...
                <div className="relative w-36 h-48 rounded-2xl overflow-hidden ring-1 ring-teal-700"
      ...
      <section className="bg-white pt-12 pb-3 px-5">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-ink-950 tracking-tight leading-none">
            Every claim,<br /><span className="text-ink-400">backed by science.</span>
          </h2>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
            ...
            <div className="lg:col-span-2 rounded-2xl p-6 relative overflow-hidden"
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-teal-100 text-[9px] font-bold tracking-[0.2em] uppercase">SPF Performance</span>
                <CheckCircle2 size={13} className="text-white/50" />
              </div>
              <p className="text-7xl font-bold text-white tracking-tight leading-none mb-1.5">50+</p>
              <p className="text-teal-100 text-[9px] font-bold tracking-widest uppercase mb-3">Tested at SPF 59.92</p>
            ...
            <div className="lg:col-span-2 rounded-2xl p-6 relative overflow-hidden"
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-red-100 text-[9px] font-bold tracking-[0.2em] uppercase">UVA Protection</span>
                <CheckCircle2 size={13} className="text-white/50" />
              </div>
              <p className="text-5xl font-bold text-white tracking-tight leading-none mb-1.5">PA++++</p>
              <p className="text-red-100 text-[9px] font-bold tracking-widest uppercase mb-3">UVAPF tested at 22.07</p>
              <p className="text-white/70 text-xs leading-relaxed">
            ...
            <div className="lg:col-span-3 rounded-2xl p-5 bg-teal-950 relative overflow-hidden">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <span className="text-teal-500 text-[9px] font-bold tracking-[0.2em] uppercase block mb-1">Water Resistance</span>
                  <h3 className="text-xl font-bold text-white tracking-tight">Water Resistant for 80 Minutes</h3>
                </div>
                <div className="text-center flex-shrink-0 ml-4">
                  <p className="text-3xl font-bold leading-none" style={{ color: "#D6FF3E" }}>94%</p>
                  <p className="text-teal-500 text-[9px] mt-0.5">SPF after 80 min</p>
                </div>
              </div>
              <p className="text-teal-400 text-xs leading-relaxed">
                After 80 minutes of water immersion, 94% of original SPF retained.
                Tested to ISO 16217 standard.
              </p>
            </div>
            ...
            <div className="lg:col-span-1 rounded-2xl p-5 bg-ink-50 border border-ink-100 flex flex-col justify-between">
              <div>
                <span className="text-ink-400 text-[9px] font-bold tracking-[0.2em] uppercase block mb-1.5">Skin</span>
                <h3 className="text-base font-bold text-ink-950 tracking-tight mb-2">Non-Comedogenic</h3>
              ...
              <span className="inline-block mt-3 text-[10px] font-semibold bg-teal-100 text-teal-700 px-2 py-1 rounded-md">33 participants</span>
            </div>

            {/* Dermatologist + Ophthalmologist */}
            <div className="lg:col-span-2 rounded-2xl p-5 bg-ink-50 border border-ink-100">
              <span className="text-ink-400 text-[9px] font-bold tracking-[0.2em] uppercase block mb-3">Clinical Testing</span>
              <div className="space-y-3">
                {[
                  ...
                  <div key={title} className="flex items-start gap-2.5">
                    ...
                    <div>
                      <p className="text-xs font-bold text-ink-900 tracking-tight">{title}</p>
            ...
            <div className="lg:col-span-2 rounded-2xl p-5 bg-teal-50 border border-teal-100">
              <div className="flex items-center justify-between mb-2">
                <span className="text-teal-600 text-[9px] font-bold tracking-[0.2em] uppercase">Hydration</span>
                <CheckCircle2 size={12} className="text-teal-600" />
              </div>
              <h3 className="text-base font-bold text-ink-950 tracking-tight mb-3">Deeply Hydrating</h3>
              ...
              <p className="text-ink-400 text-xs">Hydration increase on dry skin panel.</p>
            </div>
            ...
            <div className="lg:col-span-2 rounded-2xl p-5 bg-ink-50 border border-ink-100">
              <div className="space-y-3">
                {[
                  ...
                  <div key={title} className="flex items-start gap-2.5">
                    <Leaf size={12} className="text-teal-600 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-xs font-bold text-ink-900 tracking-tight">{title}</p>
                      <p className="text-ink-500 text-xs leading-relaxed">{body}</p>
                    </div>
            ...
            <div className="lg:col-span-2 rounded-2xl p-5 bg-ink-50 border border-ink-100">
              <div className="flex items-start gap-2.5">
                <CheckCircle2 size={12} className="text-teal-600 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-xs font-bold text-ink-900 tracking-tight">Fragrance-Free: Independently Confirmed</p>
                  <p className="text-ink-500 text-xs leading-relaxed mt-1">No fragrance, parfum, or masking fragrance. No EU fragrance allergens above the safety threshold.</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                    ...
                    <Droplets size={14} style={{ color: "#D6FF3E" }} />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-white tracking-tight">Next-Generation UV Filters</p>
      ...
      <section className="grain-overlay bg-teal-950 py-14 px-5 overflow-hidden">
        <div className="relative z-10 max-w-5xl mx-auto">
          <p className="text-teal-500 text-[9px] font-bold tracking-[0.2em] uppercase mb-4">What protects your skin</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight leading-none mb-3">
            No oxybenzone. No octinoxate.<br />
            <span style={{ color: "#D6FF3E" }}>No compromise.</span>
          </h2>
          <p className="text-teal-400 text-sm leading-relaxed max-w-lg mb-8">
            All three UV filters verified legally permitted in India and the EU, confirmed present in the formula.
            None on any global banned list.
          </p>
            ...
            {[
              ...
              <div key={name} className="rounded-xl overflow-hidden border border-teal-800">
                <div className="px-4 py-2.5 border-b border-teal-800 flex items-center justify-between" style={{ background: "rgba(255,255,255,0.03)" }}>
                  <p className="text-white text-xs font-bold tracking-tight">{name}</p>
                  <CheckCircle2 size={11} className="text-teal-600" />
                </div>
                <div className="p-4">
                  <p className="text-teal-600 text-[9px] font-mono leading-relaxed mb-2">{inci}</p>
                  <p className="text-teal-200 text-xs font-semibold mb-1.5">{role}</p>
          ...
          <div className="border border-teal-800 rounded-xl p-4" style={{ background: "rgba(255,255,255,0.02)" }}>
            <p className="text-teal-500 text-[9px] font-bold tracking-widest uppercase mb-2.5">What is not in this product</p>
            <div className="flex flex-wrap gap-1.5">
              {["No oxybenzone", "No octinoxate", "No homosalate", "No parabens", "No phenoxyethanol", "No synthetic fragrance", "No formaldehyde releasers"].map((item) => (
                <span key={item} className="flex items-center gap-1 text-[10px] font-medium px-2.5 py-1 rounded-md"
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            <div className="lg:w-1/3">
              <p className="text-teal-600 text-[9px] font-bold tracking-[0.2em] uppercase mb-3">Formula reviewed by our panel</p>
              <h2 className="text-3xl font-bold text-ink-950 tracking-tight leading-tight">Who this<br />is for</h2>
            </div>
            <div className="lg:w-2/3 grid sm:grid-cols-2 gap-2.5">
              {[
                ...
                { title: "Daily wear", detail: "Breathable, non-greasy finish. Designed for all-day use. Pairs with your existing routine.", b: "border-l-gold-500" },
                ...
                <div key={title} className={`bg-white rounded-xl p-4 border border-ink-200 border-l-4 ${b}`}>
                  <p className="text-xs font-bold text-ink-900 tracking-tight mb-1">{title}</p>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-ink-500 text-sm leading-relaxed mb-2">
                The Clean Sheet is an independent certification body with no commercial relationship with CodeSkin.
                A panel of cosmetic scientists, toxicologists, regulatory specialists, a microbiologist, a claims evaluator,
