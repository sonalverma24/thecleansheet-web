module.exports=[18622,(e,n,t)=>{n.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,n,t)=>{n.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,n,t)=>{n.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},70406,(e,n,t)=>{n.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,n,t)=>{n.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},89104,e=>{"use strict";let n=new Map,t=Date.now();e.s(["rateLimit",0,function(e,a,r){let i,o=Date.now();if(!(o-t<3e5))for(let[e,a]of(t=o,n)){let t=a.filter(e=>o-e<6e4);0===t.length?n.delete(e):n.set(e,t)}let s=`${a}:${(i=e.headers.get("x-forwarded-for"))?i.split(",")[0].trim():e.headers.get("x-real-ip")??"unknown"}`,c=(n.get(s)??[]).filter(e=>o-e<6e4);return c.length>=r?(n.set(s,c),!1):(c.push(o),n.set(s,c),!0)},"rateLimited",0,()=>Response.json({error:"Too many requests. Please wait a minute and try again."},{status:429})])},2221,e=>{"use strict";let n=`
...
`;e.s(["CHAT_SYSTEM_PROMPT",0,r,"CLEAN_SHEET_SYSTEM_PROMPT",0,n,"COMPARISON_SYSTEM_PROMPT",0,t,"EXPERT_ANSWER_SYSTEM_PROMPT",0,a])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0mltm66._.js.map