...
const products: ProductScorecard[] = [
  ...
  ------------------------------------------------- */
  {
    ...
    summary: "Simple's SPF moisturiser uses a 4-filter UV system: Octisalate (position 2), Avobenzone (position 5), Ensulizole (position 6), and Octocrylene (position 8). Crucially, Octocrylene IS present to photostabilise Avobenzone, resolving the photodegradation concern seen in the Rich Moisturiser. The formula avoids Oxybenzone and Octinoxate. Octocrylene received a SCCS opinion in 2021 noting concern for cumulative benzophenone metabolite exposure, particularly in children; adult use at EU-permitted concentrations is considered acceptable. No SPF test report is published by the brand, so consumers cannot independently verify the stated SPF level. SPF 15 blocks approximately 93% of UVB radiation - adequate for indoor or urban commute exposure but insufficient for Indian outdoor UV conditions (UV Index 8-11+) where SPF 30+ is the clinical minimum recommendation.",
    score: 64,
    scoreLabel: "Fair",
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 27, max: 40,
        note: "Ethylhexyl Salicylate (Octisalate) is the primary UV filter, appearing at position 2. Some studies have noted mild endocrine activity for Octisalate, but the concern level is considerably lower than for Oxybenzone or Octinoxate; it remains permitted in both the EU and India. Avobenzone at position 5 is paired with Octocrylene at position 8 — Octocrylene photostabilises Avobenzone, preventing the photodegradation issue present in the Rich Moisturiser (where Avobenzone appears without a stabiliser). Octocrylene itself received a 2021 SCCS opinion flagging concern about cumulative benzophenone metabolite exposure, particularly in children; adult use at EU-permitted concentrations is considered acceptable by the SCCS. This formula avoids the most problematic UV filters: no Oxybenzone (formally classified as a Category 1 Endocrine Disruptor by ECHA in 2025) and no Octinoxate (currently under active endocrine disruption review). Phenylbenzimidazole Sulfonic Acid (Ensulizole) has an excellent safety profile. No parabens, no fragrance.",
      },
      {
        name: "Formulation Quality & Efficacy",
        score: 19, max: 25,
        note: "SPF 15 blocks approximately 93% of UVB radiation. This is below the minimum SPF 30 recommended by the WHO, the American Academy of Dermatology, and Indian dermatology guidelines for outdoor UV conditions — especially relevant given India's UV Index routinely reaches 8 to 11 from March to October. The UV filter system is technically correct: Avobenzone is photostabilised by Octocrylene, and Ensulizole provides good UVB coverage with excellent water solubility. Glycerin is the primary humectant. Dimethicone provides smooth skin feel. The soothing actives — Allantoin, Bisabolol, and Panthenol — appear after phenoxyethanol in the INCI, placing all three below 1% concentration; their therapeutic contribution is limited. No PA rating is stated on the product.",
      },
      {
        name: "Ingredient Disclosure & Transparency",
        score: 11, max: 25,
    ...
    pillars: [
      {
        name: "Safety & Toxicity",
        score: 32, max: 40,
        note: "No SLES, no SLS, and no PEG compounds — this is the cleanest surfactant profile in the Simple cleanser range. Cocamidopropyl Betaine is the sole surfactant: a mild amphoteric compound with a low sensitisation profile. The rare cases of sensitivity associated with it are typically linked to manufacturing impurities (DMDM Hydantoin, amidoamine) that reputable producers actively control. Iodopropynyl Butylcarbamate (IPBC) appears at position 8 as a co-preservative. The EU permits a maximum of 0.02% IPBC in rinse-off cosmetics; the SCCS has flagged sensitisation potential for IPBC in leave-on products and at higher concentrations, but at the permitted level in a rinse-off wash with brief skin contact, regulatory risk is low. Propylene Glycol at position 3 is a known penetration enhancer, but brief rinse-off contact time substantially reduces that concern. No parabens, no fragrance, no artificial colour.",
      },
      {
        name: "Formulation Quality & Efficacy",
        score: 18, max: 25,
        note: "A single amphoteric surfactant makes this an exceptionally gentle cleanser, well suited to everyday use on sensitive skin. The limitation is that one mild surfactant may not fully remove heavy makeup, waterproof formulas, or oil-based SPF products — double cleansing with an oil-based first cleanser is recommended if you wear SPF 30+ or full-coverage makeup. Panthenol, Tocopheryl Acetate, and Glycerin provide post-cleanse conditioning and hydration. Hydroxypropyl Methylcellulose gives the gel texture but has no therapeutic skin function. At only 12 ingredients, all of them identifiable, this is one of the most honest and minimal formulas in the Simple range. Citric Acid maintains a mildly acidic pH compatible with the skin's natural 4.5 to 5.5 range.",
      },
      {
        name: "Ingredient Disclosure & Transparency",
        score: 16, max: 25,
        note: "Twelve ingredients, every one identifiable, no proprietary blend names — this is genuinely transparent formulation. No fragrance, no artificial colour — verified from the INCI. Paraben-free verified. PETA certified. 'Soap-free' is verifiable from the ingredient list. IPBC is disclosed in the INCI. 'Dermatologically tested' is stated without a published citation.",
      },
      {
        name: "Ethics & Sustainability",
        score: 7, max: 10,
        note: "PETA cruelty-free certification is independently verified. A 12-ingredient formula translates to a simpler supply chain and lower overall chemical processing footprint. Propylene Glycol is petroleum-derived. IPBC is a biocide with some documented aquatic toxicity at higher concentrations; at the permitted 0.02% rinse-off level the environmental contribution is minor.",
      },
    ],
    keyActives: [
