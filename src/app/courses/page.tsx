    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-medium text-ink-900 mb-4" style={{ fontFamily: "var(--font-display)" }}>
            Courses
          </h1>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div className="relative rounded-3xl border border-ink-100 bg-ink-50 overflow-hidden opacity-70">
            ...
            {/* Ended ribbon */}
            <div className="absolute top-4 left-4 bg-ink-400 text-white text-[10px] font-medium uppercase tracking-widest px-2.5 py-1 rounded-full z-10">
              Ended
            </div>

            <div className="p-7 pt-14">
              <div className="flex items-center gap-2 mb-4">
                <span className="inline-flex items-center gap-1.5 bg-ink-100 text-ink-400 text-xs font-normal px-3 py-1 rounded-full">
                  Live Online
                </span>
                <span className="inline-flex items-center gap-1.5 bg-ink-100 text-ink-400 text-xs font-normal px-3 py-1 rounded-full">
                  ₹299
              ...
              <h2 className="text-2xl font-medium text-ink-400 mb-2" style={{ fontFamily: "var(--font-display)" }}>
                Skincare 101
          ...
          <div className="relative rounded-3xl border-2 border-dashed border-teal-200 bg-teal-50/40 overflow-hidden flex flex-col items-center justify-center text-center p-10 min-h-[300px]">
            <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center mb-4">
              <span className="text-teal-600 text-xl font-medium">+</span>
            </div>
            <p className="text-xs font-medium text-teal-500 uppercase tracking-widest mb-2">Next Course</p>
            <h2 className="text-xl font-medium text-ink-700 mb-2" style={{ fontFamily: "var(--font-display)" }}>
              Coming Soon
            </h2>
