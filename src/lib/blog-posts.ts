...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "7 min read",
    date: "September 21, 2026",
    title: "What Would Make Me Believe Your “Clinically Proven” Claim?",
    subtitle: "When I read “clinically proven” on a skincare bottle, I want to know what I can reasonably expect from using it. Here are the six questions I want the evidence to answer, and the plain-language guidance from the regulators that backs them up.",
    excerpt: "“Clinically proven” should mean something I can check. Will the change be visible? How long will it take? Was the product tested on people with my concern? Drawing on published guidance from the US Federal Trade Commission and the UK advertising regulators, here is exactly what would raise my confidence before I buy.",
    author: "Sonal Verma",
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1600&q=80",
    content: [
      { type: "paragraph", text: "When I read “clinically proven” on a skincare bottle, I want to know what I can reasonably expect from using it." },
      { type: "paragraph", text: "Will the change be visible? How long will it take? Was the product tested on people with the concern I am buying it for?" },
      { type: "paragraph", text: "Those are the questions I want the evidence to answer." },

      { type: "paragraph", text: "In 2014, L'Oréal USA agreed to settle Federal Trade Commission charges over claims for Lancôme Génifique and L'Oréal Paris Youth Code. According to the FTC, the disputed advertising included claims that the products targeted genes to deliver younger looking skin, and the agency said the company could not substantiate them. That case concerns specific advertising at the time, not every product the company sells today." },
      { type: "callout", text: "For me, the lesson is simple: a familiar name cannot answer a question about evidence." },

      { type: "paragraph", text: "Here is what would increase my confidence." },

      { type: "numbered-heading", n: "1", text: "Show me what was actually tested" },
      { type: "paragraph", text: "Was it the finished serum, an ingredient, or a routine containing several products?" },
      { type: "paragraph", text: "Evidence needs to fit the formula, use and benefit being advertised. According to the FTC's Health Products Compliance Guidance, a study on an ingredient does not automatically establish the same result for every product that contains it. The substantiation has to match the specific claim being made." },
      { type: "bullets", items: ["My question: “Can you share the study supporting this exact product claim?”"] },

      { type: "numbered-heading", n: "2", text: "Tell me what your percentage means" },
      { type: "paragraph", text: "“90% agreed their skin felt smoother” and “a 90% reduction in wrinkles” describe different things." },
      { type: "paragraph", text: "The first reports people's opinions. The second claims a measured reduction. Consumer feedback can support an appropriately worded perception claim, but it cannot substitute for evidence of an objective effect. The UK advertising regulators, the ASA and CAP, explicitly warn against presenting a satisfaction survey as if it proved a physical result." },
      { type: "bullets", items: ["My question: “Is that number the percentage of people who agreed, or the size of the improvement?”"] },

      { type: "numbered-heading", n: "3", text: "Explain the comparison" },
      { type: "paragraph", text: "Improvement from the starting point alone does not establish how much the product caused. An appropriate comparison helps separate the product's effect from other changes." },
      { type: "paragraph", text: "Research on evidence quality points the same way: random allocation, and keeping participants or assessors unaware of who received the treatment where feasible, further reduce bias. The FTC's guidance is clear that the design should suit the claim, and that well controlled human testing is the standard it expects for objective efficacy claims." },
      { type: "bullets", items: ["My question: “Better compared with what?”"] },

      { type: "numbered-heading", n: "4", text: "Help me judge whether the result applies to me" },
      { type: "paragraph", text: "I want the participant numbers, their relevant skin characteristics, the study duration and the usage instructions." },
      { type: "paragraph", text: "There is no single participant count that makes every study convincing. As the FTC guidance notes, sample size and duration need to suit the question, and a statistically significant finding still needs to deliver a meaningful benefit to matter in real use." },
      { type: "bullets", items: ["My question: “What improvement could someone with my concern realistically expect?”"] },

      { type: "numbered-heading", n: "5", text: "Keep the promise within the finding" },
      { type: "paragraph", text: "If the evidence concerns a temporary change in appearance, I want that limitation stated clearly." },
      { type: "paragraph", text: "Before and after photographs should not exaggerate the effect through lighting or retouching. UK cosmetics guidance from the ASA and CAP specifically addresses both exaggerated imagery and the distinction between a temporary cosmetic effect and a more lasting physiological one." },
      { type: "bullets", items: ["My question: “What exactly improved, and how long was that improvement observed?”"] },

      { type: "numbered-heading", n: "6", text: "Make the evidence understandable" },
      { type: "paragraph", text: "I would like a short public summary naming the testing organisation, who funded the work, what was measured, the results and the limitations." },
      { type: "paragraph", text: "I would also ask how many participants stopped using the product and whether irritation was recorded." },
      { type: "paragraph", text: "These are my transparency expectations. An unavailable public report does not, by itself, prove a claim is false. It does leave me with less information to judge it." },
      { type: "bullets", items: ["My question: “Who ran the test, who paid for it, and where can I read a plain summary?”"] },

      { type: "divider" },

      { type: "heading", level: 2, text: "The one message I would send before buying" },
      { type: "paragraph", text: "Before my next purchase, I would send one message:" },
      { type: "callout", text: "“Could you share a plain language summary of the study behind this claim, including the product tested, participant numbers, comparison, duration, measured results and any reported reactions?”" },
      { type: "paragraph", text: "I should not need research training to understand the promise on a bottle." },
      { type: "paragraph", text: "If “clinically proven” is part of the reason I should buy it, understanding what was proven should be part of the buying experience." },

      { type: "cta", text: "Want to see whether a product's ingredients match its promises? Analyse it for free.", href: "/analyzer", label: "Analyse a Product Now" },

      { type: "heading", level: 2, text: "Sources and further reading" },
      { type: "paragraph", text: "This is an opinion piece written from a consumer's point of view. The regulatory principles referenced below are summarised from published guidance by the named authorities; the specific wording and requirements should be confirmed against the originals." },
      { type: "sources", items: [
        { text: "U.S. Federal Trade Commission (2014), “L'Oréal Settles FTC Charges Alleging Deceptive Advertising for Anti-Aging Cosmetics.” The FTC said L'Oréal could not substantiate claims that Lancôme Génifique and L'Oréal Paris Youth Code targeted genes to produce visibly younger skin.", href: "https://www.ftc.gov/news-events/news/press-releases/2014/06/loreal-settles-ftc-charges-alleging-deceptive-advertising-anti-aging-cosmetics" },
        { text: "U.S. Federal Trade Commission, “FTC Policy Statement Regarding Advertising Substantiation.” Advertisers must have a reasonable basis for a claim before making it; express proof claims such as “tests prove” or “studies show” require at least the advertised level of substantiation.", href: "https://www.ftc.gov/legal-library/browse/ftc-policy-statement-regarding-advertising-substantiation" },
        { text: "U.S. Federal Trade Commission (2022), “Health Products Compliance Guidance.” Sets out the “competent and reliable scientific evidence” standard, why evidence must match the specific claim and product, and the role of well controlled human testing.", href: "https://www.ftc.gov/business-guidance/resources/health-products-compliance-guidance" },
        { text: "ASA and CAP (UK advertising regulators), “Beauty and Cosmetics: General.” Marketers must hold evidence for efficacy claims and must not exaggerate a product's effects through implied claims or imagery.", href: "https://www.asa.org.uk/advice-online/beauty-and-cosmetics-general.html" },
        { text: "ASA and CAP, “Beauty and Cosmetics: Physiological effect.” Explains the distinction between a temporary cosmetic effect and a more lasting physiological change, and the evidence each requires.", href: "https://www.asa.org.uk/advice-online/beauty-and-cosmetics-physiological-effect.html" },
        { text: "ASA and CAP, “Beauty and Cosmetics: The use of production techniques.” Guidance on before and after imagery, retouching and post-production that could exaggerate a product's apparent performance.", href: "https://www.asa.org.uk/advice-online/cosmetics-the-use-of-production-techniques.html" },
      ] },
      { type: "paragraph", text: "Hero image courtesy of Unsplash and its photographer, used under the Unsplash License." },
    ],
  },
  {
