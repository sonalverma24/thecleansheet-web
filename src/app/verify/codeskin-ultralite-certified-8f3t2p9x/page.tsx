    ...
    <div className="bg-white min-h-screen font-sans">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-12 pb-14">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-10">
            ...
            <div className="flex-shrink-0 relative">
              <div className="relative w-44 h-56 sm:w-48 sm:h-60 rounded-2xl overflow-hidden ring-1 ring-teal-200"
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-teal-600 text-lg font-semibold tracking-tight mb-1">SPF 50+ PA++++</p>
      ...
      <div className="px-4 py-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-3">
            ...
            <div className="relative overflow-hidden rounded-2xl p-7"
              ...
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-teal-100 text-[10px] font-bold uppercase tracking-widest">SPF Performance</span>
                <CheckCircle2 size={14} className="text-white/60 ml-auto" />
              </div>
              <p className="text-7xl font-bold text-white mb-1 leading-none tracking-tight">50+</p>
              <p className="text-teal-200 text-xs font-semibold mb-4 tracking-wide uppercase">Tested at SPF 59.92</p>
            ...
            <div className="relative overflow-hidden rounded-2xl p-7"
              ...
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-red-100 text-[10px] font-bold uppercase tracking-widest">UVA Protection</span>
                <CheckCircle2 size={14} className="text-white/60 ml-auto" />
              </div>
              <p className="text-5xl font-bold text-white mb-1 leading-none tracking-tight">PA++++</p>
              <p className="text-red-200 text-xs font-semibold mb-4 tracking-wide uppercase">UVAPF tested at 22.07</p>
              <p className="text-white/70 text-xs leading-relaxed">
          ...
          <div className="rounded-2xl p-6 mb-3 border border-gold-200"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1.5">
                  <h3 className="text-sm font-bold text-ink-900 tracking-tight">Water Resistant for 80 Minutes</h3>
              ...
              <div className="flex-shrink-0 text-center bg-white rounded-xl px-5 py-3 border border-gold-200">
                <p className="text-3xl font-bold text-gold-500 tracking-tight leading-none">94%</p>
                <p className="text-ink-400 text-[10px] mt-1 font-medium uppercase tracking-wide">SPF after 80 min</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-teal-600 rounded-xl px-6 py-4">
            ...
            <div>
              <p className="text-sm font-bold text-white tracking-tight">Fragrance-Free: Independently Confirmed</p>
              <p className="text-teal-200 text-xs mt-0.5">No fragrance, parfum, or masking fragrance in the formula. No EU fragrance allergens above the safety threshold.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4 bg-ink-50 border-y border-ink-100">
        <div className="max-w-4xl mx-auto">
          <p className="text-teal-600 text-[10px] font-bold uppercase tracking-widest text-center mb-2">Formula reviewed by our panel</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-ink-950 tracking-tight text-center mb-10">Who this is for</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <div key={title} className={`bg-white rounded-xl p-5 border border-ink-200 border-l-4 ${color}`}>
                <div className="flex items-center gap-2 mb-2">
                  <CheckCircle2 size={12} className="text-teal-600 flex-shrink-0" />
                  <p className="text-sm font-bold text-ink-900 tracking-tight">{title}</p>
                </div>
                <p className="text-xs text-ink-500 leading-relaxed">{detail}</p>
              </div>
            ))}
      ...
      <div className="py-16 px-4 bg-teal-600 border-b border-teal-700">
        <div className="max-w-4xl mx-auto">
          <p className="text-teal-300 text-[10px] font-bold uppercase tracking-widest text-center mb-2">What protects your skin</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight text-center mb-3">Next-generation UV filters</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-3 mb-6">
            {[
              ...
              <div key={name} className="rounded-xl p-5 bg-white/10 border border-white/20">
                ...
                <p className="text-teal-300 text-[10px] font-mono mb-2 leading-relaxed">{tech}</p>
                <p className="text-white text-xs font-semibold mb-2 tracking-tight">{role}</p>
          ...
          <div className="bg-white/10 border border-white/20 rounded-xl p-5">
            <p className="text-teal-200 text-[10px] font-bold uppercase tracking-widest mb-3">What&apos;s not in this product</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              { value: "9", label: "Tests on file", accent: "border-gold-200 bg-gold-50", val: "text-gold-500" },
      ...
      <div className="bg-teal-600 py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-teal-200 text-xs mb-1">Certificate ID: TCS-IN-2026-048291 [SAMPLE]</p>
