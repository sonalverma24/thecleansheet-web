 ...
 * Pillar scores: independently calculated under 4-pillar framework (v3, May 2026);
  ...
  products: [
      ...
      pillars: [
        {
          ...
          score: 44,
          max: 50,
          note: "Ethylhexyl Methoxycinnamate (Octinoxate) is present in this leave-on sunscreen. Regulatory bodies in Europe and the US are actively reassessing Octinoxate over concerns about its potential to interfere with hormones - it has not been banned but restrictions are expected to tighten. The other UV filters - Uvinul A Plus, Tinosorb S, and Ethylhexyl Triazone - are modern, photostable choices with strong safety records. No Benzophenone-3, no fragrance, no azo dyes. Cyclopentasiloxane is a volatile silicone that evaporates quickly on skin, so the amount that actually absorbs is minimal.",
        },
        {
          name: "Formulation Quality",
          score: 17,
          max: 20,
          note: "SPF 50+ PA++++ is excellent broad-spectrum protection. The UV filter system is photostable, meaning protection holds up in sunlight rather than breaking down. Ascorbyl Glucoside is a stable form of Vitamin C that converts to the active form inside skin - brightening activity is real but more gradual than pure Vitamin C. Niacinamide contributes pore-minimising and anti-inflammatory benefit. Worth noting: this product is sold under the 'Vitamin C' name but uses Ascorbyl Glucoside, a derivative with lower potency than L-Ascorbic Acid, and that distinction is not explained in the product name or marketing.",
        },
        {
          name: "Claims & Transparency",
          score: 16,
          max: 20,
          note: "SPF 50+ PA++++ is claimed but the brand does not publish a test report on the product page, so consumers cannot independently verify the stated protection level. The full ingredient list is published on dotandkey.com and the UV filters are clearly identifiable. The Vitamin C form used is Ascorbyl Glucoside, not L-Ascorbic Acid - a meaningful difference in how quickly results appear - but this is not disclosed in the product name or marketing copy.",
        },
        {
          name: "Ethics & Sustainability",
          score: 6,
          max: 10,
          note: "Dot & Key is an Indian brand and does not sell in markets that require mandatory animal testing for imported cosmetics. This product contains no synthetic fragrance. Ethylhexyl Methoxycinnamate (Octinoxate) is a recognised waterway pollutant with documented effects on coral reefs, which affects the environmental profile of this formula. Packaging is plastic. Palm-derived ingredient sourcing has not been independently verified.",
        },
      ],
      keyActives: [
      ...
      pillars: [
        {
          ...
          score: 42,
          max: 50,
          note: "Parfum (synthetic fragrance) is listed as a single ingredient but can contain dozens to hundreds of undisclosed chemical compounds. Fragrance is the leading cause of contact reactions and skin sensitisation in leave-on skincare, and the specific allergens are not named, making it impossible for sensitive-skin users to assess their personal risk. Two azo dyes are also present: CI 15985 (Sunset Yellow FCF) and CI 19140 (Tartrazine). These are cosmetic colourants that serve no skin function and have documented allergen potential in some individuals; CI 19140 in particular is a known cross-reactor in people with aspirin sensitivity.",
        },
        {
          name: "Formulation Quality",
          score: 15,
          max: 20,
          note: "The active core - Ascorbyl Glucoside, Niacinamide, and Tocopherol - is a credible brightening combination with supporting evidence. Sodium Hyaluronate adds hydration. The weak points are the two azo dyes and synthetic fragrance, which contribute nothing to skin health but add allergen load to a daily moisturiser. The Vitamin C form used is Ascorbyl Glucoside, a stable derivative with lower potency than L-Ascorbic Acid. This is not explained in the product name, which could lead consumers to expect the strength of a pure L-Ascorbic Acid product.",
        },
        {
          name: "Claims & Transparency",
          score: 16,
          max: 20,
          note: "The full ingredient list is published on dotandkey.com and both the dyes and fragrance are included. However, the fragrance is listed only as 'Parfum' with no breakdown of the specific allergens it contains - which is unhelpful for consumers with sensitive skin or known fragrance sensitivities. The product is marketed under a 'Vitamin C' name but uses Ascorbyl Glucoside, not L-Ascorbic Acid - a meaningful difference in potency that consumers deserve to know. The two azo dyes are present purely as colourants, and this is not communicated.",
        },
        {
          name: "Ethics & Sustainability",
          score: 6,
          max: 10,
          note: "Synthetic azo dyes have documented effects on aquatic organisms. The fragrance composition is undisclosed. Dot & Key is an Indian brand and is not sold in markets with mandatory animal testing requirements. Packaging is plastic.",
        },
      ],
      keyActives: [
      ...
      pillars: [
        {
          ...
          score: 31,
          max: 50,
          note: "Benzophenone-3 (Oxybenzone) appears high in the ingredient list, suggesting it is present at a significant concentration - likely above 5% based on its position relative to other actives. ECHA formally classified Oxybenzone as a Category 1 Endocrine Disruptor in 2025. The FDA has requested additional safety data, and it is banned in marine-protected areas in Hawaii and Palau due to coral reef toxicity. Daily face application in meaningful quantities - as required for effective sun protection - represents real cumulative exposure. Ethylhexyl Methoxycinnamate (Octinoxate) is also present; it is separately under active review in Europe and the US for potential hormone disruption and is a recognised reef pollutant. Parfum (synthetic fragrance) is listed without naming any of its constituent allergens. Fragrance is the leading cause of contact reactions in skincare, and applying an undisclosed fragrance mixture liberally over the face daily adds meaningful sensitisation risk.",
        },
        {
          name: "Formulation Quality",
          score: 15,
          max: 20,
          note: "SPF 50 PA+++ provides solid sun protection, and Watermelon extract alongside Aloe Vera contribute soothing and hydration. The UV protection function is real. The notable formulation gap is the choice of Benzophenone-3 as a key UV filter - the brand's own Vitamin C + E Sunscreen uses a modern, photostable filter system (Tinosorb S, Uvinul A Plus, Ethylhexyl Triazone) without these safety concerns, which makes the filter choice here a meaningful step back.",
        },
        {
          name: "Claims & Transparency",
          score: 14,
          max: 20,
          note: "SPF 50 PA+++ is claimed but the brand does not publish a test report on the product page. The full ingredient list is published and all UV filters are identifiable. Parfum is listed but without any allergen breakdown. Notably, the brand's product descriptions do not acknowledge the safety concerns associated with Benzophenone-3, so consumers browsing the product page receive no context to make an informed comparison with alternative sunscreens.",
        },
        {
          name: "Ethics & Sustainability",
          score: 4,
          max: 10,
          note: "Benzophenone-3 is banned in several marine-protected areas due to documented coral reef toxicity. Ethylhexyl Methoxycinnamate also carries reef toxicity risk. Both UV filters are recognised waterway pollutants that enter the environment through rinsing and ocean swimming. Synthetic fragrance with undisclosed composition is also present. Packaging is plastic.",
        },
      ],
      keyActives: [
      ...
      pillars: [
        {
          ...
          score: 49,
          max: 50,
          note: "This is one of the cleanest safety profiles in the Dot & Key range. No fragrance, no azo dyes, no UV filters under review, and no problematic preservatives. The ceramide complex (Ceramide NP, AP, EOP) is one of the most extensively studied ingredient categories in dermatology and is safe across all skin types. Niacinamide, Panthenol, and Allantoin all carry excellent safety records. Phenoxyethanol is used as a preservative at standard cosmetic levels. Caprylic/Capric Triglyceride is a non-comedogenic coconut-derived emollient; palm-derived ingredient sourcing has not been independently verified.",
        },
        {
          name: "Formulation Quality",
          score: 19,
        ...
        },
        {
          ...
          score: 16,
          max: 20,
          note: "The full ingredient list is published on dotandkey.com and all three ceramide types are individually named and identifiable - a positive sign compared to products that list only 'ceramide complex'. The brand does not publish ceramide concentrations, and no clinical efficacy study is cited for this specific formula. Consumers can verify the ingredient presence but cannot assess the dose. Otherwise, no inflated claims are made.",
        },
        {
          name: "Ethics & Sustainability",
          score: 7,
          max: 10,
          note: "No synthetic fragrance, no azo dyes. Dot & Key is an Indian brand and is not sold in markets with mandatory animal testing requirements for imported cosmetics. Packaging is lightweight plastic. Palm-derived ingredient sourcing has not been independently verified.",
        },
      ],
      keyActives: [
    ...
    // 5. Strawberry Bright 10% Niacinamide Serum
    {
      ...
      pillars: [
        ...
        },
        {
          ...
          score: 17,
          max: 20,
          note: "10% Niacinamide is the most clinically validated concentration for pore minimising, sebum regulation, and brightening - it is the active that makes this product work. Zinc PCA adds sebum control benefit. The azo dye CI 42090 has no skin function whatsoever; it only adds colour to the formula. Strawberry extract appears at a low position in the ingredient list, which indicates a concentration likely below 1%. At that level, it contributes negligible Vitamin C or antioxidant activity - it is primarily a branding ingredient in this serum.",
        },
        {
          name: "Claims & Transparency",
          score: 17,
          max: 20,
          note: "The brand explicitly states 10% Niacinamide on the product, which is unusually transparent for a mass-market product and worth recognising. The full ingredient list is published on dotandkey.com. The 'Strawberry Bright' name and marketing prominently position Strawberry extract as a hero active, but its position in the ingredient list indicates it is likely below 1% - insufficient to deliver meaningful Vitamin C activity. The implied brightening contribution from Strawberry is not substantiated at this concentration. The azo dye is present purely as a colourant and this is not communicated to consumers.",
        },
        {
          name: "Ethics & Sustainability",
          score: 7,
          max: 10,
          note: "No synthetic fragrance. One azo dye (CI 42090) is present; azo dyes have minor documented effects on aquatic organisms. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing for imported cosmetics. Packaging is plastic.",
        },
      ],
      keyActives: [
    ...
    // 6. 10% Vitamin C + E Face Serum
    {
      ...
      pillars: [
        ...
        },
        {
          ...
          score: 17,
          max: 20,
          note: "The brand states 10% Ascorbyl Glucoside, and the Vitamin C plus Vitamin E combination is well-established in antioxidant research - the two vitamins work synergistically. Sodium Hyaluronate adds hydration. Ascorbyl Glucoside is a gentler, more stable form of Vitamin C than L-Ascorbic Acid, which is an advantage in India's heat but comes with lower potency. This distinction is not communicated in the product name. DGME enhances ingredient penetration, which may boost efficacy but also increases how much of each co-formulated ingredient the body absorbs.",
        },
        {
          name: "Claims & Transparency",
          score: 16,
          max: 20,
          note: "The brand states 10% Vitamin C on the product, which is a welcome transparency. The full ingredient list is published on dotandkey.com and DGME is listed within it. However, the penetration-enhancing properties of DGME are not explained to consumers, so buyers have no way of knowing that this ingredient increases their skin's absorption of everything else in the formula. The product name implies L-Ascorbic Acid to most consumers, but the actual form used is Ascorbyl Glucoside - a distinction that matters for anyone comparing efficacy against other Vitamin C serums.",
        },
        {
          name: "Ethics & Sustainability",
          score: 6,
          max: 10,
          note: "No synthetic fragrance, no azo dyes. Dot & Key is an Indian brand and is not sold in markets requiring mandatory animal testing for imported cosmetics. Packaging is plastic. Palm-derived ingredient sourcing has not been independently verified. DGME is a synthetic penetration enhancer currently under regulatory review.",
        },
      ],
      keyActives: [
    ...
    // 7. 72HR Hydrating Gel Moisturizer
    {
      ...
      pillars: [
        ...
        },
        {
          ...
          score: 14,
          max: 20,
          note: "The full ingredient list is published on dotandkey.com and both the fragrance and azo dye are listed. However, fragrance constituent allergens are disclosed only as 'Parfum' with no further breakdown. The '72HR Hydration' claim is not backed by any cited clinical study for this specific product. The blue dye is present purely for aesthetic reasons - this is not communicated to consumers, who may reasonably assume every ingredient in a skincare product serves a skin function.",
        },
        {
          name: "Ethics & Sustainability",
          score: 6,
          max: 10,
          note: "Synthetic fragrance is present with an undisclosed chemical composition. Azo dye CI 42090 has documented effects on aquatic organisms. Dot & Key is an Indian brand. Packaging is plastic.",
        },
      ],
      keyActives: [
    ...
    // 8. Barrier Repair Face Wash
    {
      ...
      ingredients: [
        ...
        { name: "Parfum", note: "Fragrance, present in a product for sensitive/barrier skin. Leading cause of contact reactions in facial cleansers. Allergen constituents not disclosed.", flag: "warn" },
        { name: "Phenoxyethanol", note: "Preservative at typical cosmetic level", flag: "ok" },
        { name: "Ethylhexylglycerin", note: "Co-preservative", flag: "ok" },
      ],
    ...
    // 10. Strawberry Dew Tinted Sunscreen SPF 50+
    {
      ...
      keyActives: [
        ...
        { name: "Tinosorb S (Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine)", function: "Broad-spectrum UVA/UVB filter, highly photostable" },
        { name: "Ethylhexyl Triazone", function: "UVB filter, photostable" },
        { name: "CI 77492 / CI 77491 (Iron Oxides)", function: "Mineral tint, inert, safe. Also provides visible light protection relevant for melasma" },
      ...
      ingredients: [
        ...
        { name: "CI 77492 (Iron Oxide Yellow)", note: "Mineral tint pigment, inert, safe. Provides visible light protection (melasma management benefit).", flag: "ok" },
